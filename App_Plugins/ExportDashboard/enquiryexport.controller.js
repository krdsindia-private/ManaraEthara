/* global angular */
angular.module("umbraco").controller("EnquiryExportController", function ($scope, $http, $window) {
  ...
  $scope.submitForm = function () {
    ...
    var apiUrl = "https://manarethara20230915111500.azurewebsites.net/umbraco/api/enquiry/ExportEnquiryRequestsToCsv";
